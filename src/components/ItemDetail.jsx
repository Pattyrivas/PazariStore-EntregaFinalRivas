            ...
            <div className=" px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            <span className="title-font font-medium text-xl text-gray-900 pr-4">Precio: {item.price}</span>
                            <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={handleAddToCart}>Agregar al Carrito</button>
                        ...
                        <span className="title-font font-medium text-xl text-gray-900">Disponibles: {item.stock}</span>
